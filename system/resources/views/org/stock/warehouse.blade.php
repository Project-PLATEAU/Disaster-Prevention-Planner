            ...
            <div class="frame-4">
              ...
              <div class="data-frame">
                <div class="data-frame-left">
                  <div class="data-frame-wrapper"><div class="data-frame-title">倉庫リスト</div></div>
                </div>
                <div class="data-frame-div">
                  ...
                  <button class="data-frame-button" onclick="location.href='{{route('org.stock.stock')}}';">
                  ...
                  <div class="table-div">
                    <table id="dataTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{$item->name}}</td>
                          <td><button class="link-button" onClick="showData({{$item->id}});">確認</button></td>
                          <td>
                            <form method="post" action="{{route('org.stock.stock')}}" style="display: inline;">@csrf<button class="link-button" onClick="">編集</button><input type="hidden" name="id" value="{{$item->id}}" /></form>
                            <button class="link-button" onClick="deleteData({{$item->id}})">削除</button>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
