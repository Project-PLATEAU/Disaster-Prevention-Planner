            ...
            <div class="frame-4">
                        ...
                        <div class="submenu">
                          <div class="item">
                            ...
                            <div class="submenu" id="area_subsubmenu">
                              ...
                              <div class="active-menu-3"><div class="element-level-title-2"><a href="{{route('org.stock.supply')}}">物資リスト</a></div></div>
                            </div>
                          </div>
                          <div class="item-2">
              ...
              <div class="data-frame">
                <div class="data-frame-left">
                  <div class="data-frame-wrapper"><div class="data-frame-title">物資リスト</div></div>
                </div>
                <div class="data-frame-div">
                  ...
                  <button class="data-frame-button" onclick="location.href='{{route('org.stock.item')}}';">
                    ...
                    <table id="dataTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$item->w_name}}</td>
                          <td>
                            <form method="post" action="{{route('org.stock.item')}}" style="display: inline;">@csrf<button class="link-button" onClick="">編集</button><input type="hidden" name="id" value="{{$item->id}}" /></form>
                            <button class="link-button" onClick="deleteData2({{$item->id}})">削除</button>
                          </td>
                          @endforeach
                        </tr>
                      </tbody>
