      ...
      <div class="div">
        <div class="frame">
          <div class="frame-2">
            ...
            <form class="frame-4" method="post" action="{{route('org.stock.exec2')}}">
            @csrf
              <div class="sider">
                <div class="frame-5">
                  <div class="menu-logo">
                        ...
                        <div class="submenu" id="area_submenu">
                          <div class="item">
                            ...
                            <div class="submenu" id="area_subsubmenu">
                              ...
                              <div class="active-menu-3"><div class="text-wrapper-4"><a href="{{route('org.stock.supply')}}">物資リスト</a></div></div>
                            </div>
                          </div>
                          <div class="item-2">
              ...
              <div class="frame-6">
                <div class="frame-7">
                  <div class="heading-left">
                    <div class="wrapper">
                      <div class="title-5">
                        <a href="{{route('org.stock.supply')}}"><img class="arrow-left" src="{{asset('/img/arrowleft-2.svg')}}" /></a>
                        物資 登録
                      </div>
                    </div>
                  </div>
                ...
                <div class="frame-8">
                  <div class="vertical-form-item">
                    ...
                    <select class="select-2" name="type_master" id="type_master">
                  ...
                  <div class="vertical-form-item">
                    <div class="label"><div class="title-6">品目</div></div>
                    <select class="select-2" name="item_master" id="item_master">
                      @foreach ($itemList as $item)
                      <option value="{{$item->id}}" data-val="{{$item->material_type_master_id}}">{{$item->name}}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="vertical-form-item">
                    <div class="label"><div class="title-6">数量</div></div>
                    <div class="input-div-wrapper">
                    <input id="amount" name="amount" class="input-text" placeholder="数量を入力してください" type="text" value="@isset($data){{$data->s_amount}}@endisset" />
                    </div>
                  </div>
                  <div class="vertical-form-item">
                    <div class="label"><div class="title-6">倉庫</div></div>
                    <select class="select-2" name="warehouse" id="warehouse">
                      @foreach ($warehouse as $item)
                      <option value="{{$item->id}}" @isset($data)@if ($data->w_id == $item->id)selected="selected"@endif @endisset>{{$item->name}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
              ...
              <input type="hidden" id="material_type_master_id" value="@isset($data){{$data->m2_id}}@endisset" />
              <input type="hidden" id="material_item_master_id" value="@isset($data){{$data->m1_id}}@endisset" />
            </form>
          </div>
