      ...
      <div class="div">
        <div class="frame">
          <div class="frame-2">
            ...
            <form class="frame-4" method="post" action="{{route('org.shelter.exec')}}">
            @csrf
              <div class="sider">
                <div class="frame-5">
                  <div class="menu-logo">
              ...
              <div class="frame-6">
                <div class="frame-7">
                  <div class="heading-left">
                    <div class="wrapper">
                      <div class="title-4">
                        <a href="{{route('org.shelter.index')}}"><img class="arrow-left" src="{{asset('/img/arrowleft-2.svg')}}" /></a>
                        地区一次避難場所 登録
                      </div></div>
                  </div>
                ...
                <div class="frame-8">
                  <div class="vertical-form-item">
                    <div class="label"><div class="title-5">名称</div></div>
                  ...
                  <div class="vertical-form-item">
                    ...
                    <select class="select-2" name="type">
                      <option value="1" @isset($data) @if ($data->type == 1)selected="selected" @endif @endisset>避難場所</option>
                      <option value="2" @isset($data) @if ($data->type == 2)selected="selected" @endif @endisset>避難所</option>
                    </select>
                  </div>
                  <div class="vertical-form-item-2">
                    <div class="label"><div class="text-wrapper-2">備考</div></div>
                    <textarea class="textarea" name="recital" placeholder="その他記載事項">@isset($data){{$data->recital}}@endisset</textarea>
                  </div>
                  <div class="vertical-form-item">
