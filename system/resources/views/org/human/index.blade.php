            ...
            <div class="frame-4">
              ...
              <div class="data-frame">
                <div class="data-frame-left">
                  <div class="data-frame-wrapper"><div class="data-frame-title">人的資源</div></div>
                </div>
                <div class="data-frame-div">
                  ...
                  <button class="data-frame-button" onclick="location.href='{{route('org.human.create')}}';">
                    ...
                    <table id="dataTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$item['phone']}}</td>
                          <td>
                            @if ($item['skill1'] != ''){{$item['skill1']}}@endif
                            @if ($item['skill2'] != '')<br />{{$item['skill2']}}@endif
                            @if ($item['skill3'] != '')<br />{{$item['skill3']}}@endif
                            @if ($item['skill4'] != '')<br />{{$item['skill4']}}@endif
                          </td>
                          <td>{{$item['recital']}}</td>
                          <td>
                            <form method="post" action="{{route('org.human.create')}}" style="display: inline;">@csrf<button class="link-button" onClick="">編集</button><input type="hidden" name="id" value="{{$item['id']}}" /></form>
                            <button class="link-button" onClick="deleteHuman({{$item['id']}})">削除</button>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
