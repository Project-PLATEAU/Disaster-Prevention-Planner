            ...
            <div class="frame-4">
              ...
              <div class="data-frame">
                <div class="data-frame-left">
                  <div class="data-frame-wrapper"><div class="data-frame-title">緊急連絡先</div></div>
                </div>
                <div class="data-frame-div">
                  ...
                  <button class="data-frame-button" onclick="location.href='{{route('org.emergency.create')}}';">
                    ...
                    <table id="dataTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$item->phone}}</td>
                          <td>
                            <form method="post" action="{{route('org.emergency.create')}}" style="display: inline;">@csrf<button class="link-button" onClick="">編集</button><input type="hidden" name="id" value="{{$item->id}}" /></form>
                            <button class="link-button" onClick="deleteEmergency({{$item->id}})">削除</button>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
