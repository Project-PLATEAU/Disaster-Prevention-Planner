        ...
        <div class="frame">
          <div class="frame-2">
            <div class="global-header-front">
              <div class="frame-3">
                <img class="components" src="{{ asset ('/img/image-34.png') }}" />
                <div class="text"><div class="text-wrapper"><a class="back-link" href="{{route('org.index.index')}}">地区防災計画作成支援システム 市自治会</a></div></div>
              </div>
            </div>
            <div class="frame-4">
              <div class="sider">
                  ...
                  <div class="menu-logo">
                    <div class="div-2">
                      ...
                      <div class="menu">
                        ...
                        <div class="submenu">
                          <div class="item">
                            <div class="parent-2" id="area_submenu">
                              <div class="inner-wrapper">
              ...
              <div class="data-frame">
                <div class="data-frame-left">
                  <div class="data-frame-wrapper"><div class="data-frame-title">自治会館</div></div>
                </div>
                <div class="data-frame-div">
                  ...
                  <button class="data-frame-button" onclick="location.href='{{route('org.hall.create')}}';">
                    ...
                    <table id="dataTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$item->detail}}</td>
                          <td>
                            <form method="post" action="{{route('org.hall.create')}}" style="display: inline;">@csrf<button class="link-button" onClick="">編集</button><input type="hidden" name="id" value="{{$item->id}}" /></form>
                            <button class="link-button" onClick="deleteHall({{$item->id}})">削除</button>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
