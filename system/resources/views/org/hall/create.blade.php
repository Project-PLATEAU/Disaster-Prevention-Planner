      ...
      <div class="div">
        <div class="frame">
          <div class="frame-2">
            ...
            <form class="frame-4" method="post" action="{{route('org.hall.exec')}}">
            @csrf
              <div class="sider">
                <div class="frame-5">
                  <div class="menu-logo">
                      ...
                      <div class="menu">
                        ...
                        <div class="submenu" id="area_submenu">
                          ...
                          <div class="element-level-title-wrapper">
                            <div class="element-nd-level-title"><a href="{{route('org.hall.index')}}">自治会館</a></div>
                          </div>
                        </div>
                      </div>
                      <div class="inline-menu-item-top">
              ...
              <div class="frame-6">
                <div class="frame-7">
                  <div class="heading-left">
                    <div class="wrapper"><div class="title-4"><a href="{{route('org.hall.index')}}"><img class="arrow-left" src="{{asset('/img/arrowleft-2.svg')}}" /></a> 自治会館 登録</div></div>
                  </div>
                ...
                <div class="frame-8">
                  ...
                  <div class="vertical-form-item-2">
                    ...
                    <textarea class="textarea" name="detail" placeholder="その他記載事項">@isset($data){{$data->detail}}@endisset</textarea>
                  </div>
                  <div class="vertical-form-item">
