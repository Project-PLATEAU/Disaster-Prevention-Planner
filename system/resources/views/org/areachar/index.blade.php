            ...
            <div class="frame-4">
              ...
              <div class="data-frame">
                <div class="data-frame-left">
                  <div class="data-frame-wrapper"><div class="data-frame-title">地区特性</div></div>
                </div>
                <div class="data-frame-div">
                  ...
                  <button class="data-frame-button" onclick="location.href='{{route('org.areachar.create')}}';">
                    ...
                    <table id="dataTable" style="width: 100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$item->detail}}</td>
                          <td>
                            <form method="post" action="{{route('org.areachar.create')}}" style="display: inline;">@csrf<button class="link-button" onClick="">編集</button><input type="hidden" name="id" value="{{$item->id}}" /></form>
