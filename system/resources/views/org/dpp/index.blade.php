            ...
            <div class="frame-4">
              ...
              <div class="data-frame">
                <div class="data-frame-left">
                  <div class="data-frame-wrapper"><div class="data-frame-title">地区防災計画</div></div>
                </div>
                <div class="data-frame-div">
                  <div class="create-button">
                  <button class="data-frame-button" onclick="location.href='{{route('org.dpp.exec')}}';">
                    ...
                    <div class="data-frame-text">現在の入力情報で新規作成</div>
                  </button>
                  </div>
                  <div class="table-div">
                    <table id="dataTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="link-button" target="_blank" href="{{route('org.dpp.download2', ['id' => $item->id])}}">ダウンロード(PDF)</a>
                            <a class="link-button" target="_blank" href="{{route('org.dpp.download', ['id' => $item->id])}}">ダウンロード(Excel)</a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
