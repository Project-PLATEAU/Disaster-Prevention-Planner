            ...
            <div class="frame-4">
              ...
              <div class="data-frame">
                <div class="data-frame-left">
                  <div class="data-frame-wrapper"><div class="data-frame-title">技能資格</div></div>
                </div>
                    ...
                    <table id="dataTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{$item->name}}</td>
                          <td>
                            <form method="post" action="{{route('org.master.create')}}" style="display: inline;">@csrf<button class="link-button" onClick="">編集</button><input type="hidden" name="mode" value="3" /><input type="hidden" name="id" value="{{$item->id}}" /></form>
                            <button class="link-button" onClick="deleteData(3, {{$item->id}})">削除</button>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
