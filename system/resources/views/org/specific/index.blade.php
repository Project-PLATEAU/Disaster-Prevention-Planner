            ...
            <div class="frame-4">
              ...
              <div class="data-frame">
                <div class="data-frame-left">
                  <div class="data-frame-wrapper"><div class="data-frame-title">地区特有の情報</div></div>
                </div>
                <div class="data-frame-div">
                  ...
                  <button class="data-frame-button" onclick="location.href='{{route('org.specific.create')}}';">
                    ...
                    <table id="dataTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$item->title}}</td>
                          <td>
                                <form method="post" action="{{route('org.specific.create')}}" style="display: inline;">@csrf<button class="link-button" onClick="">編集</button><input type="hidden" name="id" value="{{$item->id}}" /></form>
                            <button class="link-button" onClick="deleteSpecific({{$item->id}})">削除</button>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
